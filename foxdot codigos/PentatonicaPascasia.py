...
a1 >> pads([0,1,4,3],mix=PRange(3,8), dur= PDur(3,8),rate=PRange(1,10),drive=2)

a2 >> space([0,2,4],dur=4,room=5,amp=0.9,mix=10,chop=3)

a3 >> keys([0,2,(0,2)], dur=4,chop=[12,16,20,24,32],echotime=[2,4,8])

a4 >> zap([0,2,4,8],dur=2,oct=3,amp=0.9,spin=8,chop=8)

a5 >> soprano([0,1,4,3,2],chop=[32,64,16,3,2,4], dur= 2,rate=PRange(-10,10),amp=0.6,drive=[2,5,1,8],echotime=4,room=20)
...
hh >> play("Vn", pan=0.5, dur=PDur(2,8))

...
a1 >> sinepad([0],dur=PDur(1,16),oct=4,amp=1) 



def verse1():
    a1 >> sinepad([0],dur=PDur(1,16),oct=5,amp=0.8) 
    Clock.future(32, verse2)
def verse2():
    a2 >> sinepad([2],dur=PDur(2,16),oct=5,vib=[1,2],amp=0.8)   
    Clock.future(32, verse3)
def verse3():
    a8 >> sinepad([4],dur=PDur(3,16),oct=[5],vib=[10,2,4],amp=0.6)
    a3 >> sinepad([6],dur=PDur(4,16),glide=0.5,oct=3,vib=.2,amp=0.6) 
    Clock.future(16, chorus1)
def chorus1():
    a4 >> pads([8],dur=4,glide=0.5,oct=5,vib=4,amp=0.5) 
    a5 >> pads([0],dur=PDur(6,16),amp=0.4,oct=5)  
    Clock.future(32, chorus2)
def chorus2():    
    d3 >> play("l", dur=PDur(7,16),amp=0.07,sample=[1,2,3,4]).every(7,"stutter", 3)
    d1.stop()
    d2.stop()
    Clock.future(16, chorus3)
def chorus3():
    a6 >> twang([10],dur=PDur(8,16),sample=[1,2,3,4],oct=5,amp=0.02).every(4,"stutter", 3).every(3,"stutter", 2).every(2,"stutter", 6) 
    a4 >> pulse([2,4,0,6,8,10,12],dur=PDur(12,16),oct=5,amp=0.05,tremolo=1,sample=[1,2,3,4]).every(4,"stutter", 3).every(3,"stutter", 2).every(2,"stutter", 6) 
